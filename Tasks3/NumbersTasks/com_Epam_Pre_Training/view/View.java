...
public class View {
	...
	public static void printGreatestSimpleDivisor(int firstNumber, int
	 secondNumber, int divisor) {
		System.out.println("НОД чисел " + firstNumber + " и " + secondNumber + "равен " + divisor);
	 }

	public static void printLeastCommonMultiple(int firstNumber, int
	 secondNumber, int multiple) {
	...
	public static void prtinEagles(int quantityToss, int eagles) {
		System.out.println("В " + quantityToss + " бросках выпал орел");
	}
}
